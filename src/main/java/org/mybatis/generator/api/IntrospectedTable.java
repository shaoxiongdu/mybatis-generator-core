...
public abstract class IntrospectedTable {
    ...
    public IntrospectedColumn getColumn(String columnName, boolean ignore) {
        if (columnName == null) {
            return null;
        } else {
    ...
    public String getGetList() {
        return internalAttributes.get(InternalAttribute.ATTR_GET_LIST);
    }

    public void setGetList(String s) {
        internalAttributes.put(InternalAttribute.ATTR_GET_LIST, s);
    }

    public String getGetOne() {
        return internalAttributes.get(InternalAttribute.ATTR_GET_ONE);
    }

    public void setGetOne(String s) {
        internalAttributes.put(InternalAttribute.ATTR_GET_ONE, s);
    }

    public String getListByPage() {
        return internalAttributes.get(InternalAttribute.ATTR_LIST_BY_PAGE);
    }

    public void setListByPage(String s) {
        internalAttributes.put(InternalAttribute.ATTR_LIST_BY_PAGE, s);
    }

    public String getInsert() {
        return internalAttributes.get(InternalAttribute.ATTR_INSERT);
    }

    public void setInsert(String s) {
        internalAttributes.put(InternalAttribute.ATTR_INSERT, s);
    }

    public String getUpdate() {
        return internalAttributes.get(InternalAttribute.ATTR_UPDATE);
    }

    public void setUpdate(String s) {
        internalAttributes.put(InternalAttribute.ATTR_UPDATE, s);
    }

    public String getDelete() {
        return internalAttributes.get(InternalAttribute.ATTR_DELETE);
    }

    public void setDelete(String s) {
        internalAttributes.put(InternalAttribute.ATTR_DELETE, s);
    }

    public String getBuildCriteria() {
        return internalAttributes.get(InternalAttribute.ATTR_BUILD_CRITERIA);
    }

    public void setBuildCriteria(String s) {
        internalAttributes.put(InternalAttribute.ATTR_BUILD_CRITERIA, s);
    }
    ...
    protected void calculateJavaServiceAttributes() {
        ...
        // 设置service名称
        setMyBatis3JavaServiceType(calculateJavaServiceInterfacePackage()+"."+fullyQualifiedTable.getDomainObjectName());
        // 设置方法名
        setGetList("getList");
        setGetOne("getOne");
        setListByPage("listByPage");
        setInsert("insert");
        setUpdate("update");
        setDelete("delete");
