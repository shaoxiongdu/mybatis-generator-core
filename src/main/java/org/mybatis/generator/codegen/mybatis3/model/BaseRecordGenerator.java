...
public class BaseRecordGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        commentGenerator.addClassComment(topLevelClass, introspectedTable,"model");
        ...
        //topLevelClass.addImportedType(new FullyQualifiedJavaType("com.hxl.tob.common.mybatis.Comment"));
