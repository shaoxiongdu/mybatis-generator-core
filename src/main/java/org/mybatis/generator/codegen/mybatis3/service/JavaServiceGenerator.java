...
public class JavaServiceGenerator extends AbstractJavaClientGenerator {
    ...
    public JavaServiceGenerator(String project, boolean requiresMatchedXMLGenerator) {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(
                context.getJavaServiceGeneratorConfiguration().getTargetPackage()+".api.service."+modelType.getShortName()+"Service");
