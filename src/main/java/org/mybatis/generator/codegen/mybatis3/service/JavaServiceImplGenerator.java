...
public class JavaServiceImplGenerator extends AbstractJavaClientGenerator {
    ...
    public JavaServiceImplGenerator(String project, boolean requiresMatchedXMLGenerator) {
    ...
    public List<CompilationUnit> getCompilationUnits() {
         ...
         * 2. 设置类名
         */
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(context.getJavaServiceGeneratorConfiguration().getTargetPackage()+".service.remote."+modelType.getShortName()+"ServiceImpl");
         ...
         * 3. 设置继承的service，并导包
         */
        FullyQualifiedJavaType impl = new FullyQualifiedJavaType(context.getJavaServiceGeneratorConfiguration().getTargetPackage()+".api.service."+modelType.getShortName()+"Service");
        ...
        /*
         * 5. 添加InnerService，并导包
         */

        FullyQualifiedJavaType innerService = new FullyQualifiedJavaType(
                context.getJavaServiceGeneratorConfiguration().getTargetPackage()+".service.inner."+modelType.getShortName()+"InnerService");
//        FullyQualifiedJavaType mapper = new FullyQualifiedJavaType(
//                introspectedTable.getMyBatis3JavaMapperType());
        Field field = new Field(innerService.getInjectName(), innerService);
        field.setVisibility(JavaVisibility.PRIVATE);
        field.addAnnotation("@Autowired");
        topLevelClass.addField(field);
        topLevelClass.addImportedType("org.springframework.beans.factory.annotation.Autowired");
        topLevelClass.addImportedType(innerService);
