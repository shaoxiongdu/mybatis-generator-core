 ...
 * @author laiyanlin
 */
public class UpdateMethodOfControllerGenerator extends AbstractJavaServiceImplMethodGenerator {
	@Override
	public void addServiceElements(TopLevelClass topLevelClass) {
        ...
        method.addAnnotation("@PostMapping(\"/"+introspectedTable.getUpdate()+"\")");
		...
		bodyLineSB.append(service.getInjectName() + "." + introspectedTable.getUpdate() + "(req)>0);");
		method.addBodyLine(bodyLineSB.toString());


        context.getCommentGenerator().addGeneralMethodComment(method,
                introspectedTable,"更新");
