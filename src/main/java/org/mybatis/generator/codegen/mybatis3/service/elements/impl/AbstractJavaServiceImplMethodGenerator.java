...
public abstract class AbstractJavaServiceImplMethodGenerator extends
        AbstractGenerator {
    public abstract void addServiceElements(TopLevelClass topLevelClass);
    ...
    protected void addGeneratedKeyAnnotation(Interface interfaze, Method method,
                                             GeneratedKey gk) {
        StringBuilder sb = new StringBuilder();
        IntrospectedColumn introspectedColumn = introspectedTable.getColumn(gk.getColumn(), true);
