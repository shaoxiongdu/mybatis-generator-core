...
import org.mybatis.generator.codegen.mybatis3.service.*;
    ...
    protected void calculateJavaModelGenerators(List<String> warnings,
        ...
        if (getRules().generateJavaService()) {
            ...
            initializeAbstractGenerator(javaInnerServiceGenerator, warnings,
                    progressCallback);
            javaGenerators.add(javaInnerServiceGenerator);

            AbstractJavaClientGenerator javaInnerServiceImplGenerator = new JavaInnerServiceImplGenerator(getModelProject());
            initializeAbstractGenerator(javaInnerServiceImplGenerator, warnings,
                    progressCallback);
            javaGenerators.add(javaInnerServiceImplGenerator);

            AbstractJavaClientGenerator javaControllerGenerator = new JavaControllerGenerator(getModelProject());
