...
public class MyBatisGeneratorConfigurationParser {
    ...
    private void parseContext(Configuration configuration, Node node) {
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            } else if("author".equalsIgnoreCase(childNode.getNodeName())){ // 作者
                parseAuthor(context, childNode);
            ...
            } else if ("javaServiceGenerator".equalsIgnoreCase(childNode.getNodeName())){ // 解析serviceGenerator
                parseJavaServiceGenerator(context,childNode);
            }else if ("javaControllerGenerator".equalsIgnoreCase(childNode.getNodeName())){ // 解析controllerGenerator
     ...
     * @param node
     */
    private void parseAuthor(Context context, Node node){
        AuthorConfiguration author = new AuthorConfiguration();
        context.setAuthorConfiguration(author);
